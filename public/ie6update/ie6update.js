...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'This server is using Modern AAC, and therefore developers of Modern AAC seriously dislike Internet Explorer, and we see you are using it. Click here to update to Google Chrome alright? Thank you!')
