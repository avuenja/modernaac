...
$(function() {
	...
	script_url : 'http://127.0.0.1/ide_aac/public/js/tinymce/jscripts/tiny_mce/tiny_mce.js',
	// General options
	theme : "advanced",
	...
	theme_advanced_buttons2 : ",fontselect,fontsizeselect, cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote",
	theme_advanced_buttons3 : "tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions",
	theme_advanced_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak",
	theme_advanced_buttons5 : "image,cleanup,help,code,|,insertdate,inserttime,preview,|,forecolor,backcolor|,undo,redo,|,link,unlink,anchoriespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen",
