<?php 
	if(!$_POST) {
		$_POST['name'] = $board[0]['name'];
		$_POST['description'] = $board[0]['description'];
		$_POST['access'] = $board[0]['access'];
		$_POST['closed'] = $board[0]['closed'];
		$_POST['moderators'] = $board[0]['moderators'];
		$_POST['order'] = $board[0]['order'];
	}
echo error(validation_errors());
echo form_open("admin/edit_board/".$board[0]['id']);
