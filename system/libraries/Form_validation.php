...
class CI_Form_validation {
	...
	/* Extended by Paxton 22/04/2010 - If the core is extended no system files should be replaced. */
	function alpha_space($str)
	{
		return ( ! preg_match("/^([a-z0-9' ])+$/i", $str)) ? FALSE : TRUE;
	}
	
	/* Function by Paxton, improved by tatu hunter */
	...
	/* Extended by Paxton 30/04/2010 - If the core is extended no system files should be replaced. */
	function alpha_space_ide($str)
	{
